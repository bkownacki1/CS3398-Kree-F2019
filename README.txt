...
------------------------------
Ben Status:
    - Added most of the significant parking lots (about 50) available at Texas State as polygons on the map.
    - Added event listener to all polygons to open a unique info window when each polygon is clicked on.
    - Added css for txst-table used in all info windows
    - Changed business map features saturation so they stand out less than our added features.
    - Halved number of lines of code of map.js by drawing each of the polygons with a for loop rather than one-by-one
    - Replaced lorem ipsum on index.html and about.html to real text about us and our project.
    - Added icon for map marker to make the info window actually pop up when polygon is clicked.

    Artifacts:
      - changed index.html, about.html, master.css, map.js
      - location: /Term_Project/Soft_Eng_Proj/WebPage_Front_End/index.html, master.css, master.js
      - location: /Term_Project/Soft_Eng_Proj/WebPage_Front_End/WebImages/TransparentMarker.png
...
Retrospective:
    ...
    Sam Pugh:
	    ...
	    * The communication is improving.
          ...
          Ben:
          * We got a lot of busy work done and added some good functionality.
          * We got distracted by the midterm so the end of the sprint really snuck up on us. We were able to add most of the planned sprint features late.
          * We talked a lot more in Slack and in person, despite a lot of absences due to illness.
          * I really super underestimated how much time it was going to take for all my sprint tasks. I scheduled about 10 hours but ended up working for over 20.
		...
		* Start contributing more.
	        ...
	        * Communication can still improve and outside issues dampened our ability to finish tasks quicker.
            ...
            Ben:
              * Set reasonable goals, make better time estimations.
              * Remember when the sprint ends.
		...
		* Communicate more with the team so that I am able to contribute more
	        ...
	        * Finish tasks and try to keep up with the group.
            ...
            Ben:
              * Talk every day to make sure we are planning to work on the project even if we don't work on it every day.
